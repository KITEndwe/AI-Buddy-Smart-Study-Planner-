...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        ...
        $stmt = $pdo->prepare("INSERT INTO students (programme_id, first_name, last_name, email, password_hash, year_of_study, semester, added_by_admin) VALUES (?, ?, ?, ?, ?, ?, ?, 1)");
        $stmt->execute([$programmeId, $first, $last, $email, $hash, $year, $semester]);
